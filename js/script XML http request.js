window.addEventListener('DOMContentLoaded', () => {
    ...
    function postData(form) {
        form.addEventListener('submit', (e) => {
            ...
            const object = {}; 
            formData.forEach(function(value, key) { // перебрали обєкт formData в НОВИЙ обєкт
                object[key] = value;
            });

            const json = JSON.stringify(object); //перенесли дані з обєкта у формат джсон

            request.send(json); // formData -> json
